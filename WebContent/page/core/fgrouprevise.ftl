              ...
              <div class="panel-body">
                <form id="form">
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control" id="g_name" name="g_name" placeholder="组名" value="${fg.g_name}">
                   </div>
                   <div class="form-group">
                     <label for="g_remark">描述</label>
                     <textarea name="g_remark" id="g_remark" cols="30" rows="10" class="form-control">${fg.g_remark}</textarea>
                   </div>
                   <div class="form-group">
                        <label for="">组标识</label>
                              <div class="row">
                                <div class="col-sm-12">
                                  <section class="panel">
                                    <div class="panel-body">
                                      <table class="table table-bordered tag-wrap">
                                        <tbody style="font-size: 20px;">
                                          ...
                                          <tr>
                                              <td><i class="fa fa-cogs"></i> <input type="radio" name="g_tag" value="fa-cogs" id="g_tag"></td>
                                              <td></td>
                                              <td></td>
                                              <td></td>
                                              <td></td>
                            ...
                            <input type="hidden" name="g_id" value="${fg.g_id}">
...
<script type="text/javascript">
    $(function(){
        var tag = '${fg.g_tag}';
        if (!!tag) {
            $('.tag-wrap').find('.'+tag).next().attr("checked","checked");
        }
    });
</script>
</body>
