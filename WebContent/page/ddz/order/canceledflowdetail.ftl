            	    ...
            	    <div class="col-xs-12">
            	        <section class="panel">
            	            ...
            	            <div class="panel-body">
            	                <form class="form-inline" action="/order/canceledflowlist/detail" method="POST">
                          ...
                          <section class="panel">
                              ...
                              <div class="panel-body">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td class="info">撤销时间</td>
                                        <td class="info" colspan="3">撤销备注</td>
                                        <td class="info">撤销管理员</td>
                                        <td class="info">撤销类型</td>
                                        <td class="info">是否减少任务单量</td>
                                        <td class="info"></td>
                                        <td class="info"></td>
                                        <td class="info"></td>
                                    </tr>
                                    <tr>
                                        <td>${detail.cancel_time?string('yyyy-MM-dd HH:mm:ss')}</td>
                                        <td colspan="3">${detail.cancel_remark}</td>
                                        <td>${detail.cancel_admin}</td>
                                        <td>
                                            <#switch detail.cancel_type>
                                                <#case 0>自动撤销<#break>
                                                <#case 1>商品找不到<#break>
                                                <#case 2>达不到商家备注要求<#break>
                                                <#case 3>买手主动撤销<#break>
                                                <#case 4>问题任务<#break>
                                                <#case 20>管理员撤销<#break>
                                                <#case 21>申诉撤销<#break>
                                        ...
                                        <td><#if detail.is_reduce_task=0>否<#else>是</#if></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                    </tr>
